...
@section('content')
    <div class="main-content position-relative">
        ...
        <div class="container-fluid py-4">
            <div class="row" style="max-height: 680px;">
                ...
                <form action="{{route("admin.lophoc.update", $lophoc->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body" style="height: 85vh">
                                <div class="d-flex align-items-center">
                                    <p class="mb-0">Cập nhật lớp học</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="mon_hoc_id" id="" class="form-control">
                                                <option value="{{$lophoc->mon_hoc_id}}" hidden>{{$monhoc->ten_mon_hoc}}
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="giang_vien_id" id="" class="form-control">
                                                <option value="{{$lophoc->giang_vien_id}}" hidden>{{$giangvien->ho_ten}}
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="chuyen_nganh" id="" class="form-control">
                                                <option value="{{$lophoc->chuyen_nganh}}" hidden>{{$lophoc->chuyen_nganh}}
                                                </option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control me-auto" id="sinhvienDaChon"
                                                ...
                                                value="{{ implode(',', $sinhvienLop->pluck('sinh_vien_id')->toArray()) }}">
                        ...
                        <div id="danhSachCheckbox">
                            @foreach ($sinhviens as $sinhvien)
                                <div class="form-check data-item">
                                    <input class="form-check-input sv" type="checkbox" name="sinhviens[]"
    ...
    <script>
        ...
        var dataSv = @json($sinhvienLop);
        var sinhviens = document.querySelectorAll('.sv')
        sinhviens.forEach(sinhvien => {
            dataSv.forEach(sv => {
                if (sv.sinh_vien_id == sinhvien.value) {
                    sinhvien.checked = true;
                }
            })
        });
