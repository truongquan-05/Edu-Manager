    ...
    <main class="main-content mt-0">
        <section>
                            ...
                            <div class="card card-plain">
                                    ...
                                    <form method="POST" action="{{ route('login.post') }}">
                                        ...
                                        <div class="mb-3">
                                            <input type="password" name="password" class="form-control form-control-lg"
                                                placeholder="Mật khẩu" aria-label="Mật khẩu" required>
                                        </div>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        ...
                                        <a href="javascript:;" class="text-primary text-gradient font-weight-bold">Đăng
                                            ký</a>
                                    </p>
                                </div>
                            </div>
          ...
          background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Chú ý là đồng tiền
                                    mới"</h4>
                                <p class="text-white position-relative">Càng dễ dàng khi viết, người viết càng phải nỗ
                                    lực nhiều hơn trong quá trình.</p>
                            </div>
                        </div>
                    </div>
                </div>
