    ...
    <main class="main-content mt-0">
        <section>
          ...
          background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">Edu Manager</h4>
                                <p class="text-white position-relative">Trụ sở chính Tòa nhà FPT Polytechnic, Phố Trịnh Văn Bô, Nam Từ Liêm, Hà Nội</p>
                            </div>
                        </div>
                    </div>
                </div>
